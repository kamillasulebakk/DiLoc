...
def main(
    ...
    save_file_name: str = f'simple_network_tanh_sigmoid_{N_samples}_12july_mseloss_MSE_dipole_w_amplitude_{N_epochs}_SGD_lr{lr}_mom{momentum}_wd_{weight_decay}_bs{batch_size}'
