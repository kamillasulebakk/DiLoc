...
# THIS NETWORK IS AT THE MOMENT USED FOR DIPOLE_W_AMPLITUDE
# class Net(nn.Module):
...
def main(
    ...
    save_file_name: str = f'tanh_{N_samples}_6july_mseloss_MSE_dipole_w_amplitude_{N_epochs}_SGD_lr{lr}_wd{weight_decay}_mom{momentum}_bs{batch_size}'
