...
class Net(nn.Module):
    def __init__(self, N_dipoles: int, determine_area: bool = False):
        ...
        ## DO NOT DELETE!!
        # 8 times, 6 layers
        self.fc1 = nn.Linear(231, 128*8)
        self.fc2 = nn.Linear(128*8, 64*8)
        self.fc3 = nn.Linear(64*8, 32*8)
        self.fc4 = nn.Linear(32*8, 32*8)
        self.fc5 = nn.Linear(32*8, 32)
    ...
    def forward(self, x: torch.Tensor):
        ...
        # self.determine_area = determine_area
        # super().__init__()
        # self.fc1 = nn.Linear(231, 128*10)
        # self.fc2 = nn.Linear(128*10, 64*10)
        # self.fc3 = nn.Linear(64*10, 32*10)
        # self.fc4 = nn.Linear(32*10, 32*8)
        # self.fc5 = nn.Linear(32*8, 32*4)
        # self.fc6 = nn.Linear(32*4, 32*2)
        # self.fc7 = nn.Linear(32*2, 32)
        #
        # if determine_area:
...
def main(
    ...
    save_file_name: str = f'new_architecture_(times10)(8layers)_standarisation_w_amplitude_{N_epochs}_SGD_lr{lr}_wd{weight_decay}_bs{batch_size}'
