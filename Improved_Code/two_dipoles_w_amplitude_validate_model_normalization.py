...
# model = torch.load('trained_models/criterion_MSE_10000_11may_MSE_area_w_amplitude_1500_SGD_lr1.5_wd0.1_mom0.35_bs64.pt')
# model = torch.load('trained_models/criterion_MSE_50000_11may_MSE_area_w_amplitude_1000_SGD_lr0.1_wd0.25_mom0.35_bs128.pt')
model = torch.load('trained_models/criterion_MSE_50000_11may_MSE_area_w_amplitude_1500_SGD_lr0.9_wd0.1_mom0.35_bs128.pt')
...
eeg = np.load('data/validate_dipoles_w_amplitudes_eeg_70000_2.npy')
target = np.load('data/validate_dipoles_w_amplitudes_locations_70000_2.npy')
...
target = target.T.reshape(np.shape(target)[0], 4*N_dipoles)
target = target[:1000,:]
